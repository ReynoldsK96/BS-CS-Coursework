...
public class Lab5
{
   ...
   */
   private static int[] problem1(Node root) {
      ...
      if ((root.left == null) && (root.right != null)) {
         children = problem1(root.right);
         children[1] += 1;
         return children;
      } 
      
      if ((root.left != null) && (root.right == null)) {
         children = problem1(root.left);
         children[1] += 1;
         return children;
       }
   ...
   */
   private static int problem2(Node root) {
      ...
      if (root == null) {
         ...
         int left = problem2(root.left);
         int right = problem2(root.right);
   ...
   private static boolean testProblem1(int[][] testCase)
   {
      ...
      if (answer == null || answer.length != solution.length) 
         return false;
