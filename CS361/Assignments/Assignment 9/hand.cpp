...
bool hand::operator<(hand& h) {
    if (h.handValueHigh() > 21) {
        return handValueHigh() < h.handValueLow();
    }
    else if (handValueHigh() > 21) {
        return handValueLow() < h.handValueHigh();
    }
    else if (h.handValueHigh() > 21 && handValueHigh() > 21) {
        return handValueLow() < h.handValueLow();
    }
    else {
        return handValueHigh() < h.handValueHigh();
    }
...
bool hand::operator==(hand& h) { return handValueHigh() == h.handValueHigh(); }
