...
public class ManipulateImage {
   ...
   public static int imageHeightInfo(BufferedImage buff, String fileName) {
      int imageHeight = buff.getHeight();
      System.out.println("The image " + fileName + " has a height of " + imageHeight + " pixels.");
      return imageHeight;
   }
   public static int imageWidthInfo(BufferedImage buff, String fileName) {
      int imageWidth = buff.getWidth();
      System.out.println("The image " + fileName + " has a height of " + imageWidth + " pixels.");
      return imageWidth;
   }
   public static int imageTypeInfo(BufferedImage buff, String fileName) {
      int imageType = buff.getType();
      System.out.println("The image " + fileName + " is of type " + imageType + " .");
      return imageType;
   }
   public static void printImageInfo(BufferedImage buff, String fileName) {
      imageHeightInfo(buff, fileName);
      imageWidthInfo(buff, fileName);
      imageTypeInfo(buff, fileName);
   }
   ...
   public static void main(String[] args) {
      ...
      while (true) {
         ...
         if (fileName.equals("q")) {
            System.out.println("Okay, buh-bye");
            break;
         }
