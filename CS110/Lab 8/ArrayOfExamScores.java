...
// Date: 03/04/2021
// Description: ArrayOfExamScores.java
...
public class ArrayOfExamScores {
   ...
   public static void main(String[] args) {
      ...
      System.out.println(". . . generating scores . . .");
      ...
      for (int i = 0; i < numStudentsInClass; i++) {
         arrayOfTestScores[i] = randomNumbers.nextInt(101);
      ...
      double result = (double)runningTotal/numStudentsInClass;
      ...
      // screen.
      System.out.println("The maximum score of " + maximumScore +
                         " was attained by student " + maximumScoreStudent);
   }
}
